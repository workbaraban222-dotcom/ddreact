...
const DD_API_ENDPOINTS = ["/api/site"];
...
const DD_DEFAULT_DATA = {
  ...
  pages: [
    { number: "01", title: { ua: "Соцмережі", en: "Social media", ru: "Соцсети" }, text: { ua: "Instagram, TikTok, Telegram та інші площадки.", en: "Instagram, TikTok, Telegram and other platforms.", ru: "Instagram, TikTok, Telegram и другие площадки." }, href: "/shop" },
    { number: "02", title: { ua: "Реклама", en: "Ads", ru: "Реклама" }, text: { ua: "Профілі, бізнес-менеджери і запускові сетапи.", en: "Profiles, business managers and launch setups.", ru: "Профили, бизнес-менеджеры и запусковые сетапы." }, href: "/shop" },
    { number: "03", title: { ua: "Пошта і сервіси", en: "Mail and services", ru: "Почта и сервисы" }, text: { ua: "Поштові акаунти і інфраструктура під команди.", en: "Mail accounts and team infrastructure.", ru: "Почтовые аккаунты и инфраструктура под команды." }, href: "/shop" },
