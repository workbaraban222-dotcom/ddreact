...
<html lang="ru" class="dd-boot">
  <head>
    ...
    </script><title>РњР°С‚РµСЂРёР°Р» | DOUBLE DAMAGE</title>
  ...
  <body>
    ...
    <main data-article-page></main>
    <aside class="cart-panel" aria-hidden="true"><div class="cart-head"><div><p class="eyebrow" data-i18n="cart">РљРѕСЂР·РёРЅР°</p><h2 data-i18n="cartOrder">Р’Р°С€ Р·Р°РєР°Р·</h2></div><button class="icon-button" type="button" data-cart-close>x</button></div><div class="cart-items" data-cart-items></div><div class="cart-total"><span data-i18n="total">РС‚РѕРіРѕ</span><strong data-cart-total>$0</strong></div></aside><div class="cart-backdrop" data-cart-close></div>
    <footer class="footer"><span data-footer-copy></span></footer>
